...
export const fil: Dictionary = {
  ...
  order: {
    ...
    callConsentLabel: "Sang-ayon akong tawagan ako para ma-confirm ang order ko.",
    errorCallConsentRequired: "Kailangan mo munang i-check ito.",
    submitting: "Ipinapadala…",
    noPaymentNote: "Walang bayad ngayon — kukumpirmahin muna ang order sa tawag.",
    reserveNote: "Iwan ang iyong numero para ma-reserve ang FLEXOLEX sa kasalukuyang presyo.",
    ...
    successBody: "Natanggap na namin ang Flexolex request mo.",
    successEyebrow: "One last step",
    successHeadline: "Sagutin ang tawag namin para ma-confirm ang Flexolex order mo",
    successStepRequest: "Request",
    successStepConfirm: "Confirm",
    successStepDelivery: "Delivery",
    successCardEyebrow: "Susunod na hakbang",
    successCardHeadline: "Keep your phone nearby",
    successNote: "Tatawag sa iyo ang aming Flexolex representative para ma-confirm ang order mo.",
    successFooter: "Please answer the call para matapos ang confirmation.",
